...
abstract class AbstractAlgorithmsTests {
    ...
    fun optimizeBuyAndSell(optimizeBuyAndSell: (String) -> Pair<Int, Int>) {
        ...
        assertEquals(3 to 5, optimizeBuyAndSell("input/my_buysell_test.txt"))
        assertEquals(18 to 20, optimizeBuyAndSell("input/my_buysell_test_2.txt"))
    ...
    fun longestCommonSubstring(longestCommonSubstring: (String, String) -> String) {
        ...
        assertEquals("е", longestCommonSubstring("ПрИвеТ", "котлета"))
        assertEquals("лет", longestCommonSubstring("Таблетки", "котлетКи"))
